                  ...
                  <div class="p-5">
                    ...
                    <form enctype="multipart/form-data" class="user" method="post" action="<?= base_url('auth/register'); ?>" >
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="exampleInputNama" placeholder="Nama Pengguna" name="nama" value="<?= old('nama'); ?>">

                        <?php if(session('errors.nama')): ?>
                          <small class="text-danger pl-3"><?= session('errors.nama'); ?></small>
                        <?php endif; ?>
                      ...
                      <div class="form-group row">
                        <div class="col-md-6 mb-3 mb-md-0">
                          <input type="password" class="form-control form-control-user" id="password1" placeholder="Password" name="password1">
                           <?php if(session('errors.password1')): ?>
                             <small class="text-danger pl-3"><?= session('errors.password1'); ?></small>
                           <?php endif; ?>
                        </div>
                        <div class="col-md-6">
